...
class LearningLogic:
    ...
    def show_whole_file_in_file(self):
        self.show_whole_file_in_file = os.listdir(self.indication_file_with_words())

        if self.show_whole_file_in_file.__len__() == 0:
            self.show_whole_file_in_file.append("Empty")
        return self.show_whole_file_in_file
